...
const SEA_ADJ = {
  1001: { seas:[1002,1005], coasts:[] },        // Stormhaven Sea
  1002: { seas:[1001,1003,1011], coasts:[] },   // Coldwater Strait
  1003: { seas:[1002,1004,1011,1012], coasts:[] }, // Ironwaves Deep
  1004: { seas:[1003,1010], coasts:[] },        // Northtide Reach
  1005: { seas:[1001,1006], coasts:[] },        // Westgale Ocean
  1006: { seas:[1005,1007,1008], coasts:[] },   // Deepmist Bay
  1007: { seas:[1006,1008], coasts:[] },        // Shadowtide Gulf
  1008: { seas:[1006,1007,1009,1011], coasts:[] }, // Goldensea Basin
  1009: { seas:[1008,1010,1012], coasts:[] },   // Southcurrent Deep
  1010: { seas:[1004,1009], coasts:[] },        // Eastwater Expanse
  1011: { seas:[1002,1003,1008,1012], coasts:[] }, // Midchannel Waters
  1012: { seas:[1003,1009,1011], coasts:[] },   // Innerdeep Passage
};
